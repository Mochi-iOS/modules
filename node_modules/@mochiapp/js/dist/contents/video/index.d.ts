export * from './types';
import { PlaylistID, PlaylistItemsOptions, PlaylistItemsResponse } from '../../interfaces/source/types';
import { PlaylistEpisodeSourcesRequest, PlaylistEpisodeSource, PlaylistEpisodeServerRequest, PlaylistEpisodeServerResponse } from './types';
/**
...
export type VideoContent = {
     ...
     */
    playlistEpisodes(playlistId: PlaylistID, options?: PlaylistItemsOptions): Promise<PlaylistItemsResponse>;
    /**
     * Retrieves an episode's available sources and servers.
     *
     * @param req
     */
    playlistEpisodeSources(req: PlaylistEpisodeSourcesRequest): Promise<PlaylistEpisodeSource[]>;
    /**
