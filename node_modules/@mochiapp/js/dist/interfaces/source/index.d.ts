...
import { SearchFilter, SearchQuery, Playlist, DiscoverListing, PlaylistDetails, DiscoverListingsRequest, PlaylistID } from './types';
/**
 ...
 * @public
 */
export declare abstract class SourceModule {
    /**
     ...
     */
    abstract discoverListings(request?: DiscoverListingsRequest): Promise<DiscoverListing[]>;
    /**
