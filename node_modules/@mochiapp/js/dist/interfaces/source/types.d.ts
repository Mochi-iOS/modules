...
export declare enum DiscoverListingType {
    default = 0,
    rank = 1,
    featured = 2
}
export declare enum DiscoverListingOrientationType {
    portrait = 0,
    landscape = 1
}
...
export declare enum PlaylistPreviewType {
    video = 0,
    image = 1
}
...
export type PlaylistItemsOptions = PlaylistItemsOptionFetchGroup | PlaylistItemsOptionFetchPage;
/**
